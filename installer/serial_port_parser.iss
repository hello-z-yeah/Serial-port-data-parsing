...
#define MyAppExeName       "SST_串口工具.exe"
...
OutputDir=..\release
OutputBaseFilename=SST_串口工具_Setup_{#MyAppVersion}_x64
...
Source: "..\dist\SST_串口工具\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
; 用户配置、产品 JSON、日志和原始数据位于 %LOCALAPPDATA%\SST_串口工具，卸载时保留。
